...
function HalfSection(props: any) {
  return (
    <section className={props.className}>
      ...
      <TextBlock  textAlign={props.textAlign} header={props.header} text={props.text}/>
      <NumberBlock src={props.src2} lineStyles={props.stylesForLine} styles={props.numberSt}/>
      <TextBlock textAlign={props.textAlign} headerStyle={props.headerStyle} textWrapStyle={props.textWrapStyle} header={props.header2} text={props.text2}/>
    </section>
  );
}
